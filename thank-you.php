      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-12 ftco-animate mb-5 text-center">
            ...
            <h1 style="font-size: 41px;">شكرا لإستخدامك خدمات موقع بخدمتك</h1>
            <h1 style="font-size: 41px;">سيتم التواصل معك لاستكمال الإجرائات من قبل موظفين بخدمتك</h1><br>
            <a href="index-php.php" class="btn btn-primary py-3 px-4"> الصفحة الرئيسية</a>
          </div>
        </div>
      </div>
    </section>
