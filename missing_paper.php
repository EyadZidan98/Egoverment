      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">التبليغ عن وثائق مفقودة <i class="fa fa-chevron-right"></i></a></span>
              <span class="mr-2"><a href="index.html">خدماتنا <i class="fa fa-chevron-right"></i></span> <span class="mr-2"> الصفحة الرئيسية  <i class="fa fa-chevron-right"></i></span></a></p>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div style="margin-left: 200px;" class="row">
          ...
          <form method="POST" action="missing-client.php">
           ...
           <label for="cars">اختر الخدمة:
			...
			<select class="form-control" name="service" id="services" required>
  				<option value="missing_id_card">التبليغ عن هوية مفقودة</option>
  				<option value="missing_birth_cirtificate">التبليغ عن شهادة ميلاد مفقودة</option>
  				<option value="missing_passport">التبليغ عن جواز سفر مفقود</option>
  				<option value="missing_license">التبليغ عن رخصة قيادة مفقودة</option>
...
<section class="ftco-section">
      <div class="container">
        <div class="row justify-content-center pb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">خدماتنا</span>
            <h2>التبليغ عن الوثائق المفقودة</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12 col-md">
