      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">دفتر عائلة <i class="fa fa-chevron-right"></i></a></span>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <form method="POST" action="family-client.php">
		   ...
		   <label>الإسم الأول <input style="width: 360px;" value="<?php echo $_SESSION['user_fname']; ?>" type="text" name="f_name" class="form-control" required></label> 
			...
			<div style="margin-left: 215px;" class="col-sm-12 col-md">
           <label>رقم دفتر العائلة<input style="width: 360px;" type="text" name="family_num" class="form-control" required></label>
			</div>
           ...
           <label for="cars">اختر الخدمة :
			...
			<select class="form-control" name="service" id="services" required>
  				<option value="new">إصدار دفتر عائلة جديد</option>
  				<option value="renew">تجديد دفتر العائلة</option>
  				<option value="edit">تعديل دفتر العائلة</option>
