      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">صور مصدقة <i class="fa fa-chevron-right"></i></a></span>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <form method="POST" action="copies-client.php">
			...
			<div style="margin-left: 215px;" class="col-sm-12 col-md">
           <label for="cars">اختر نوع الصورة المراد تصديقها:

			<select class="form-control" name="service" id="services" required>
  				<option value="id_card">صورة مصدقة عن الهوية</option>
  				<option value="passport">صورة مصدقة عن الجواز</option>
  				<option value="family_book">صورة مصدقة عن دفتر العائلة</option>
  				<option value="birth_certificate">صورة مصدقة عن شهادة الميلاد</option>
  				<option value="tawjehi_certificate">صورة مصدقة عن شهادة التوجيهي</option>
  				<option value="uni_certificate">صورة مصدقة عن الشهادة الجامعية</option>
