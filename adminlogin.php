    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <form method="POST" action="loginadmin-client.php">
            
			<div style="margin-left: 215px;" class="col-sm-12 col-md">
             <label>username<input style="width: 250px;" type="text" name="username" class="form-control"></label>
            </div>
		   
		   <div style="margin-left: 215px;" class="col-sm-12 col-md">
             <label>password<input style="width: 250px;" type="password" name="pass" class="form-control"></label> <br>
             </div>
