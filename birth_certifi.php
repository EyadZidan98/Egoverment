      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">شهادة ميلاد <i class="fa fa-chevron-right"></i></a></span>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <form method="POST" action="birth-client.php">

			<div style="margin-left: 215px;" class="col-sm-12 col-md">
            <label>الرقم الوطني<input style="width: 250px;" value="<?php echo $_SESSION['nat_id']; ?>" type="text" name="nationalID" class="form-control" required></label>
           </div>
		   
		   <div style="margin-left: 215px;" class="col-sm-12 col-md">
		   <label>الإسم الأول <input style="width: 250px;" value="<?php echo $_SESSION['user_fname']; ?>" type="text" name="f_name" class="form-control" required></label> 
			</div>

			<div style="margin-left: 215px;" class="col-sm-12 col-md">
            <label>الإسم الثاني <input style="width: 250px;" value="<?php echo $_SESSION['user_mname']; ?>" type="text" name="m_name" class="form-control" required></label> 
			</div>

			<div style="margin-left: 215px;" class="col-sm-12 col-md">
            <label>الإسم الأخير <input style="width: 250px;" value="<?php echo $_SESSION['user_lname']; ?>" type="text" name="l_name" class="form-control" required></label> 
          </div>
           ...
           <label for="cars">اختر الخدمة:
			...
			<select class="form-control" name="service" id="services" required>
  				<option value="first_time">شهادة ميلاد لأول مرة</option>
  				<option value="new">اصدار شهادة ميلاد جديدة لواحدة موجودة من قبل</option>
  				<option value="edit">تعديل شهادة الميلاد</option>
