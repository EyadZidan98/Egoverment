      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index-php.php">سجل معنا <i class="fa fa-chevron-right"></i></a></span>
              <span class="mr-2"><a href="index-php.php">خدماتنا <i class="fa fa-chevron-right"></i></a></span> <span> الصفحة الرئيسية  <i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread">خـــدمـــاتـــنا</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <form method="POST" action="signup-client.php">
            
             <label>الرقم الوطني<input style="width: 360px;" type="text" name="nationalID" class="form-control"></label>
            <label>الإسم الأول <input style="width: 360px;" type="text" name="f_name" class="form-control"></label> 
            <label>الإسم الثاني <input style="width: 360px;" type="text" name="m_name" class="form-control"></label> 
            <label>الإسم الأخير <input style="width: 360px;" type="text" name="l_name" class="form-control"></label> 
            <label>البريد الإلكتروني<input style="width: 360px;" type="text" name="email" class="form-control"></label> 
             <label>رقم الهاتف<input style="width: 360px;" type="text" name="phone" class="form-control"></label> 
             <label>الرقم السري<input style="width: 360px;" type="password" name="pass" class="form-control"></label> <br>
             <input type="submit" class="btn btn-primary py-3 px-4" name="signup" value="سجل">
          </form>
