    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div style="margin-left: 200px;" class="row">
          ...
          <form method="POST" action="passport-client.php">
           ...
           <label for="cars">اختر الخدمة :
			...
			<select class="form-control" name="service" id="services" required>
  				<option value="new">اصدار جواز جديد</option>
  				<option value="renew">تجديد جواز</option>
  				<option value="edit">تعديل معلومات الجواز</option>
