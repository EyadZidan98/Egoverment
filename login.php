      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index-php.php">تسجيل الدخول <i class="fa fa-chevron-right"></i></a></span>
              <span class="mr-2"><a href="index-php.php">خدماتنا <i class="fa fa-chevron-right"></i><span> الصفحة الرئيسية  <i class="fa fa-chevron-right"></i></span></a></span> </p>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <form method="POST" action="login-client.php">
             <div style="margin-left: 215px;" class="col-sm-12 col-md">
             <label>الرقم الوطني<input style="width: 250px;" type="text" name="nationalID" class="form-control"></label>
           </div>
		   <div style="margin-left: 215px;" class="col-sm-12 col-md">
             <label>الرقم السري<input style="width: 250px;" type="password" name="pass" class="form-control"></label> <br></div>
             <input style="margin-left: 320px;" type="submit" class="btn btn-danger1 py-3 px-4" name="signup" value="سجل">

          </form>
          <br><hr><br>
          <a style="margin-left: 250px;" href="adminlogin.php" class="btn btn-danger py-3 px-4">Login As Adminstrator</a>
